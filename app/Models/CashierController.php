...
{ 
    ...
    public function cashierDailyTransactions()
    {
        ...
        ->select('paymenttransactions.*, regstudents.studstatus, students_col.studstatus, students_shs.studstatus, students_ibed.studstatus')
        ->join('regstudents', 'regstudents.studfullname = paymenttransactions.studfullname', 'left')
        ->join('students_col', 'students_col.studfullname = paymenttransactions.studfullname', 'left')
        ->join('students_ibed', 'students_ibed.studfullname = paymenttransactions.studfullname', 'left')
        ->join('students_shs', 'students_shs.studfullname = paymenttransactions.studfullname', 'left')
        ...
        // $query1 = $this->paymentransactionsModel
        ...
        // $query2 = $this->paymentransactionsModel
        // ->SELECT('paymenttransactions.*, students_ibed.*')
        // ->JOIN('students_ibed', 'students_ibed.studfullname = paymenttransactions.studfullname', 'left')
        // ->WHERE('paymenttransactions.isdel', 0)
        // ->orderBy('paymenttransactions.paymentdate', 'DESC')
        // ->orderBy('paymenttransactions.paymenttime', 'DESC')
        ...
        // $query3 = $this->paymentransactionsModel
        // ->SELECT('paymenttransactions.*, students_shs.*')
        // ->JOIN('students_shs', 'students_shs.studfullname = paymenttransactions.studfullname', 'left')
        // ->WHERE('paymenttransactions.isdel', 0)
        // ->orderBy('paymenttransactions.paymentdate', 'DESC')
        // ->orderBy('paymenttransactions.paymenttime', 'DESC')
        ...
        // $query4 = $this->paymentransactionsModel
        // ->SELECT('paymenttransactions.*, students_col.*')
        // ->JOIN('students_col', 'students_col.studfullname = paymenttransactions.studfullname', 'left')
        // ->WHERE('paymenttransactions.isdel', 0)
        // ->orderBy('paymenttransactions.paymentdate', 'DESC')
        // ->orderBy('paymenttransactions.paymenttime', 'DESC')
