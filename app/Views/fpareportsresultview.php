                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table" style="font-size: 12px">
                                ...
                                <tbody>
                                    <?php foreach($resultfaculty as $resfaculty):?>
                                        <tr>
                                            <td><?= $resfaculty['empnum']; ?></td>
                                            <td><?= $resfaculty['empfullname']; ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-primary"
                                                onclick="window.location.href='<?= base_url(); ?>hrd-fpareportsfaculty-result/<?= $resfaculty['empid']; ?>'">
                                                    VIEW PERFORMACE
                                                </button>
                                            </td>
                                        </tr>
