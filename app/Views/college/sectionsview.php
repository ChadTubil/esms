                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('col-sections'); ?>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <label class="form-label" for="exampleFormControlSelect1">COURSE</label>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $sectiond['secid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('col-sections/update/'.$sectiond['secid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-sm-12">
                                                                            <label class="form-label" for="exampleFormControlSelect1">COURSE</label>
                                                                                <select name="course" class="form-select" id="exampleFormControlSelect1">
                                                                                <option value="<?php echo $sectiond['courid']; ?>" selected>
                                                                                    <?php echo $sectiond['code']; ?>
                                                                                </option>
                                                                                <?php foreach ($coursedata as $coursed): ?>
                                                                                    <option value="<?php echo $coursed['courid']; ?>"><?php echo $coursed['code']; ?></option>
                                                                                <?php endforeach; ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-6 col-sm-12">
                                                                            <label class="form-label" for="exampleFormControlSelect1">LEVEL</label>
                                                                                <select name="level" class="form-select" id="exampleFormControlSelect1">
                                                                                <option value="<?php echo $sectiond['level']; ?>" selected>
                                                                                    <?php echo $sectiond['level']; ?>
                                                                                </option>
                                                                                <option value="1st Year">1st Year</option>
                                                                                <option value="2nd Year">2nd Year</option>
                                                                                <option value="3rd Year">3rd Year</option>
                                                                        ...
                                                                        <div class="col-lg-6 col-sm-12">
                                                                            <label class="form-label" for="exampleFormControlSelect1">SEMESTER</label>
                                                                                <select name="semester" class="form-select" id="exampleFormControlSelect1">
                                                                                <option value="<?php echo $sectiond['sem']; ?>" selected>
                                                                                    <?php echo $sectiond['sem']; ?>
                                                                                </option>
                                                                                <option value="1st Semester">1st Semester</option>
                                                                                <option value="2nd Semester">2nd Semester</option>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>col-sections/delete/<?= $sectiond['secid']; ?>';">
                                                        <span class="btn-inner">
