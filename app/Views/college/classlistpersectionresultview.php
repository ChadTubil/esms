            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <?php endif; ?>
                        <?php echo form_open('col-classlist-persection'); ?> 
                            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View"
                                                    onclick="window.location.href='<?= base_url(); ?>col-classlist-persection-students/<?= $assessmentd['secid']; ?>'">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Print"
                                                    href='<?= base_url(); ?>col-classlist-persection-print/<?= $assessmentd['secid']; ?>' target="_blank">
                                                    <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                    
