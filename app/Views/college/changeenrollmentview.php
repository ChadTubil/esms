                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">SELECT STUDENT TO CHANGE ENROLLMENT</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($studentsdata as $studentsd):?>
                                        <tr>
                                            <td style="text-align: left;"><?= $studentsd['studentno']; ?></td>
                                            <td style="text-transform: uppercase; text-align: left;"><?= $studentsd['studfullname']; ?></td>
                                            <td style="text-align: center;">
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="PROCESS"
                                                    onclick="window.location.href='<?= base_url(); ?>col-change-enrollment/process/<?= $studentsd['studid']; ?>';">
