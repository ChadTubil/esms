                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $coursed['courid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $coursed['courid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('col-course/update/'.$coursed['courid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">CODE</label>
                                                                        <input type="text" name="code" class="form-control"
                                                                        value="<?php echo $coursed['code']; ?>">
                                                                    </div>
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">COURSE</label>
                                                                        <input type="text" name="course" class="form-control"
                                                                        value="<?php echo $coursed['name']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>col-course/delete/<?= $coursed['courid']; ?>';">
                                                        <span class="btn-inner">
