                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <button class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Disable"
                                                        onclick="window.location.href='<?= base_url(); ?>studentmanagement/disable/<?= $sm['uid']; ?>'"
                                                        <?php if($sm['ustatus'] == 1){echo 'hidden';}else{} ?>>
                                                    ...
                                                    <button class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable"
                                                        onclick="window.location.href='<?= base_url(); ?>studentmanagement/enable/<?= $sm['uid']; ?>';"
                                                        <?php if($sm['ustatus'] == 0){echo 'hidden';}else{} ?>>
                                                        <span class="btn-inner">
                                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $sm['uid']; ?>">
                                                        <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $sm['uid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="staticBackdropLabel">UPDATE - <?= $sm['username'] ?></h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <?= form_open('studentmanagement/update/'.$sm['uid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">ACCOUNT NO.</label>
                                                                        <input type="text" name="account" class="form-control" value="<?php echo $sm['uaccountid']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">USERNAME</label>
                                                                        <input type="text" name="username" class="form-control" value="<?php echo $sm['username']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">PASSWORD</label>
                                                                        <input type="text" name="password" class="form-control" value="<?php echo $sm['upassword']; ?>">
                                                                    </div>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>studentmanagement/delete/<?= $sm['uid']; ?>';">
                                                        <span class="btn-inner">
