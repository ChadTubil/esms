                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h5 class="card-title">
                                <?php foreach($shsratesdata as $shsratesd) :?>
                                    <h3>RATE SET UP FOR: <strong><?= $shsratesd['sy']; ?> - <?= $shsratesd['code']; ?> <?= $shsratesd['level']; ?></strong></h3>
                                <?php endforeach; ?>
                            </h5>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?php foreach($shsratesdata as $shsratesd) :?>
                            <?= form_open('shs-rates/setup/'.$shsratesd['rateid']); ?>
                            <h6 style="margin-left: 10px;">ACTIONS:</h6>
                            <button class="btn btn-success" type="submit" style="margin-left: 10px;">SAVE</button>
                            <a class="btn btn-primary" onclick="location.href='<?= base_url() ?>shs-rates'" style="margin-left: 10px;">BACK</a>
                            <br>
                            <br>
                            <div class="row">
                                <div class="col-lg-5 col-sm-12" style="text-align: center;">
                                    ...
                                    <br>
                                    <?= form_open('shs-rates/dues/'.$shsratesd['rateid']); ?>
                                        <div class="form-group row" style="text-align: right;">
                                    ...
                                    <div class="form-group row" style="text-align: right;">
                                        ...
                                        <div class="col-sm-11" style="text-align: left;">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <?php if(empty($shsrddata)): ?>
                                                        <tr>
                                                            <td>-</td>
                                                            <td>No due dates set.</td>
                                                        </tr>
                                                    <?php else : ?>
                                                        <?php foreach($shsrddata as $rdd) :?>
                                                            <tr>
                                                                <td><?= $rdd['name']; ?></td>
                                                                <td><?php 
                                                                    ...
                                                                    <div class="modal fade" id="editDues<?= $rdd['rdid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content dark">
                                                                                ...
                                                                                <?= form_open('shs-rates/dues/update/'.$rdd['rdid']); ?>
                                ...
                                <div class="col-lg-5 col-sm-12" style="text-align: center;">
                                    <?= form_open('shs-rates/rof/'.$shsratesd['rateid']); ?>
                                                                    ...
                                                                    <div class="modal fade" id="editROF<?= $rofd['rofid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content dark">
                                                                                ...
                                                                                <?= form_open('shs-rates/rof/update/'.$rofd['rofid']); ?>
                                                                                <div class="modal-body" style="text-align: left;">
                                                                                    <div class="form-group">
