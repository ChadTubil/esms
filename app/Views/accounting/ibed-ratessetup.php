                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h5 class="card-title">
                                <?php foreach($ibedratesdata as $ibedratesd) :?>
                                    <h3>RATE SET UP FOR: <strong><?= $ibedratesd['sy']; ?> - <?= $ibedratesd['name']; ?></strong></h3>
                                <?php endforeach; ?>
                            </h5>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?php foreach($ibedratesdata as $ibedratesd) :?>
                            <?= form_open('ibed-rates/setup/'.$ibedratesd['rateid']); ?>
                            <h6 style="margin-left: 10px;">ACTIONS:</h6>
                            <button class="btn btn-success" type="submit" style="margin-left: 10px;">SAVE</button>
                            <a class="btn btn-primary" onclick="location.href='<?= base_url() ?>ibed-rates'" style="margin-left: 10px;">BACK</a>
                            <br>
                            <br>
                            <div class="row">
                                <div class="col-lg-5 col-sm-12" style="text-align: center;">
                                    ...
                                    <div class="form-group row" style="text-align: right;">
                                        <label class="control-label col-sm-3 align-self-center mb-0">TUITION FEE: ₱</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" name="tf" 
                                                <?php if($ibedratesd['tf'] == '0.00'): ?>
                                                    step="0.01" type="number" placeholder="Enter Tuition Fee Rate"
                                                <?php else: ?>
                                                    type="text" value="<?= $ibedratesd['tf']; ?>"
                                                <?php endif; ?> 
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <br>
                                    <?= form_open('ibed-rates/dues/'.$ibedratesd['rateid']); ?>
                                        <div class="form-group row" style="text-align: right;">
                                    ...
                                    <div class="form-group row" style="text-align: right;">
                                        ...
                                        <div class="col-sm-11" style="text-align: left;">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <?php if(empty($ibedrddata)): ?>
                                                        <tr>
                                                            <td>-</td>
                                                            <td>No due dates set.</td>
                                                        </tr>
                                                    <?php else : ?>
                                                        <?php foreach($ibedrddata as $rdd) :?>
                                                            <tr>
                                                                <td><?= $rdd['name']; ?></td>
                                                                <td><?php 
                                                                    ...
                                                                    <div class="modal fade" id="editDues<?= $rdd['rdid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content dark">
                                                                                ...
                                                                                <?= form_open('ibed-rates/dues/update/'.$rdd['rdid']); ?>
                                ...
                                <div class="col-lg-5 col-sm-12" style="text-align: center;">
                                    <?= form_open('ibed-rates/rof/'.$ibedratesd['rateid']); ?>
                                    ...
                                    <div class="form-group row" style="text-align: right;">
                                        ...
                                        <div class="col-sm-11" style="text-align: left;">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <?php if(empty($ibedrofdata)): ?>
                                                        <tr>
                                                            <td>-</td>
                                                            <td>No other fees set.</td>
                                                        </tr>
                                                    <?php else : ?>
                                                        <?php foreach($ibedrofdata as $rofd) :?>
                                                            <tr>
                                                                <td><?= $rofd['name']; ?></td>
                                                                    ...
                                                                    <div class="modal fade" id="editROF<?= $rofd['rofid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content dark">
                                                                                ...
                                                                                <?= form_open('ibed-rates/rof/update/'.$rofd['rofid']); ?>
                                                                                <div class="modal-body" style="text-align: left;">
                                                                                    <div class="form-group">
