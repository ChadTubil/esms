                        ...
                        <?= form_open('ibed-rates'); ?>
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <select name="level" class="form-select" id="SEM" style="width: 100%;">
                                        <option selected="" disabled=""></option>
