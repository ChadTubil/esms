                                        ...
                                        <?php if($resstud['studisdel'] == 0): ?>
                                            <tr>
                                                ...
                                                <td style="text-transform: uppercase">
                                                    <?php if($resstud['studfullname'] == ''): ?>
                                                        <?= $resstud['studln']; ?>, <?= $resstud['studfn']; ?> <?= $resstud['studmn']; ?>
                                                    <?php else: ?>
                                                        <?= $resstud['studfullname']; ?>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View Account"
                                                        onclick="window.location.href='<?= base_url(); ?>old-student-accounts/view/<?= $resstud['studentno']; ?>'">
