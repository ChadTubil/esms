                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($roomdata as $roomd):?>
                                        <tr>
                                            <td><?= $roomd['roomid']; ?></td>
                                            <td><?= $roomd['roomcode']; ?></td>
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $roomd['roomid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $roomd['roomid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('rooms/update/'.$roomd['roomid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">ROOM</label>
                                                                        <input type="text" name="rcode" class="form-control" value="<?php echo $roomd['roomcode']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">DESCRIPTION</label>
                                                                        <input type="text" name="rdescription" class="form-control" value="<?php echo $roomd['room']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>rooms/delete/<?= $roomd['roomid']; ?>';">
                                                        <span class="btn-inner">
