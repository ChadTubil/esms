    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open('assessment-cor'); ?>
                            <div class="row">
                                        ...
                                        <tr>
                                            <td><?php 
                                                foreach($studentinfo as $studinfo){
                                                    if($studinfo['studid'] == $etdd['studno']){
                                                        echo $studinfo['studentno'];
                                                    }
                                                }
                                            ?></td>
                                            <td style="text-transform: uppercase"><?= $etdd['fullname']; ?></td>
                                            <td style="text-transform: uppercase">
                                                <?php 
                                                    foreach($course as $cour){
                                                        if($cour['courid'] == $etdd['course']){
                                                            echo $cour['courcode'];
                                                        }
                                                    }
                                                    $etdd['course']; 
