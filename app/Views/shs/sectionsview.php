                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('shs-sections'); ?>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <label class="form-label" for="exampleFormControlSelect1">CLUSTER</label>
                                        <select name="cluster" class="form-select" id="exampleFormControlSelect1">
                                            <option selected="" disabled=""></option>
                                            <?php foreach ($clusterdata as $cluid): ?>
                                                <option value="<?php echo $cluid['cluid']; ?>"><?php echo $cluid['code']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                </div>
                                <div class="col-lg-3 col-sm-12">
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $sectiond['secid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('shs-sections/update/'.$sectiond['secid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-sm-12">
                                                                            <label class="form-label" for="exampleFormControlSelect1">CLUSTER</label>
                                                                                <select name="cluster" class="form-select" id="exampleFormControlSelect1">
                                                                                <option value="<?php echo $sectiond['cluid']; ?>" selected>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>shs-sections/delete/<?= $sectiond['secid']; ?>';">
                                                        <span class="btn-inner">
