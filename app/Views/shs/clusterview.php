                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $clusterd['cluid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $clusterd['cluid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="staticBackdropLabel">UPDATE CLUSTER</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <?= form_open('shs-cluster/update/'.$clusterd['cluid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">CODE</label>
                                                                        <input type="text" name="code" class="form-control"
                                                                        value="<?php echo $clusterd['code']; ?>">
                                                                    </div>
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">CLUSTER</label>
                                                                        <input type="text" name="cluster" class="form-control"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>shs-cluster/delete/<?= $clusterd['cluid']; ?>';">
                                                        <span class="btn-inner">
