                                        ...
                                        <?php if($resstud['studisdel'] == 0): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Create Credentials"
                                                        style="background-color: #b82b43; color: white;"
                                                        onclick="window.location.href='<?= base_url(); ?>students/credentials/<?= $resstud['studentno']; ?>'"
