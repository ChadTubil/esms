...
<?= $this->section('content'); ?>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if(session()->getTempdata('success')) :?>
                            ...
                            <?php endif; ?>
                        <div class="row">
                            <?php foreach($enrollmenthistoryibeddata as $stud): ?>
                            <div class="col-lg-12 col-sm-12">
                                <h5>NAME: <strong><?= $stud['studfullname']; ?></strong></h5>
                                <br>
                                <?= form_open('ibed-advising/process/'.$stud['studid']); ?>
                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="curriculum" class="form-select" required>
                                                        <?php foreach($ibedcurriculumdata as $ibedcurriculumd): ?>
                                                            <option value="<?= $ibedcurriculumd['currid']; ?>"><?= $ibedcurriculumd['code']; ?> - <?= $ibedcurriculumd['sy']; ?> <?= $ibedcurriculumd['name']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="section" class="form-select" required>
                                                        <?php foreach($ibedsectiondata as $ibedsectiond): ?>
                                                            <option value="<?= $ibedsectiond['secid']; ?>"><?= $ibedsectiond['section']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <a class="btn btn-success" style="width: 100%;"
                                                        ...
                                                        onclick="window.location.href='<?= base_url(); ?>ibed-advising/submit-account/<?= $stud['studid']; ?>'">
                                                        <span class="btn-inner">
                                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                    
                                        ...
                                        <div class="col-lg-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <a class="btn btn-danger" style="width: 100%;" data-bs-toggle="tooltip" data-bs-placement="top" title="CANCEL"
                                                    onclick="window.location.href='<?= base_url(); ?>ibed-admission/process-cancel/<?= $stud['ehid']; ?>'">
                                                    <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php else: ?>
            <?php foreach($ibedassessmentdata as $ibedassessmentd): ?>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        <h5>Student Name: <strong><?= $ibedassessmentd['studfullname']; ?></strong></h5>
                                        <h5>Address: <strong><?= $ibedassessmentd['studstbarangay']; ?> <?= $ibedassessmentd['studcity']; ?>, <?= $ibedassessmentd['studprovince']; ?></strong></h5>
                                    </div>
                                    <div class="col-lg-6 col-sm-12">
                                        <h5>Level/Class: <strong><?= $ibedassessmentd['name']; ?> - <?= $ibedassessmentd['section']; ?></strong></h5>
                                        <h5>School Year: <strong><?= $ibedassessmentd['sy']; ?></strong></h5>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
            ...
            <?php endforeach; ?>
            <?php foreach($ibedratedata as $ibedrated): ?>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" style="width: 100%;">
                                                <tbody>
                                                    <tr>
                                                        <td>Tuition</td>
                                                        <td style="text-align: right;">₱<?= $ibedrated['tf']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" style="width: 100%;">
                                                <tbody>
                                                    <?php foreach($ibedrofdata as $ibedrofd): ?>
                                                        <?php if($ibedrofd['rateid'] == $ibedrated['rateid']): ?>
                                                            <tr>
                                                                <td><?= $ibedrofd['name']; ?></td>
                                                                <td style="text-align: right;">₱<?= $ibedrofd['otherfees']; ?></td>
                                                            </tr>
                                                        <?php else: ?>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?php 
                                                                $totalotherfees = 0;
                                                                foreach($ibedrofdata as $ibedrofd) {
                                                                    if($ibedrofd['rateid'] == $ibedrated['rateid']) {
                                                                        $totalotherfees += $ibedrofd['otherfees'];
                                                                    }
                                                                }
                                            ...
                                            <table class="table" style="width: 100%;">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;">
                                                            <?php 
                                                                $grandtotal = $ibedrated['tf'] + $totalotherfees;
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table" style="width: 100%;">
                                                <tbody>
                                                    <?php foreach($ibedrddata as $ibedrdd): ?>
                                                        <?php if($ibedrdd['rateid'] == $ibedrated['rateid']): ?>
                                                            <tr>
                                                                <td><?= $ibedrdd['name']; ?></td>
                                                                <td><?php 
                                                                    $formatted = (new DateTime($ibedrdd['due']))->format('F j, Y');
                                                                    echo $formatted;
                                                                ?></td>
                                                            </tr>
                                                        <?php else: ?>
