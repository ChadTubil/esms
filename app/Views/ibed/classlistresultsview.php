            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <?php endif; ?>
                        <?php echo form_open('ibed-classlist'); ?> 
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <label class="form-label" for="validationDefault01">SELECT LEVEL</label>
                                    <select name="level" class="form-select">
                                        <option>-</option>
                                        <?php foreach($levelsdata as $leveld): ?>
                                            <option value="<?= $leveld['levelid']; ?>"><?= $leveld['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-sm-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View"
                                                    onclick="window.location.href='<?= base_url(); ?>ibed-classlist-students/<?= $assessmentd['secid']; ?>'">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Print"
                                                    ...
                                                    href="<?= base_url('ibed-classlist-print/'.$assessmentd['secid']) ?>" 
                                                    target="_blank">
