                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $lvld['ibedlvlid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $lvld['ibedlvlid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('ibed-level/update/'.$lvld['ibedlvlid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">CODE</label>
                                                                        <input type="text" name="code" class="form-control"
                                                                        value="<?php echo $lvld['code']; ?>">
                                                                    </div>
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">LEVEL</label>
                                                                        <input type="text" name="level" class="form-control"
                                                                        value="<?php echo $lvld['name']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>ibed-level/delete/<?= $lvld['ibedlvlid']; ?>';">
                                                        <span class="btn-inner">
