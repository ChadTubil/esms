        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <?php foreach($studentsibeddata as $stud): ?>
                        <div class="card-body">
                            <?= form_open('ibed-admission/process/'.$stud['studid']); ?>
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php if($stud['studentno'] == ''): ?>
                                                        <a class="btn btn-info" style="width: 100%"
                                                            ...
                                                            onclick="window.location.href='<?= base_url(); ?>ibed-admission/process-generate/<?= $stud['studid']; ?>'">
                                                            GENERATE
                                                        </a>
                                                    <?php else: ?>
                                            ...
                                            <div class="col-lg-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lrn" class="form-control" value=" ">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-12">
