                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($enrollmenthistoryibeddata as $enrollmenthistoryibeddata):?>
                                        <tr>
                                            <td style="text-align: left;">
                                                <?php
                                                    if($enrollmenthistoryibeddata['studentno'] == '') {
                                                        echo "NEW STUDENT";
                                                    } else {
                                                        echo $enrollmenthistoryibeddata['studentno'];
                                                    } 
                                                ?>
                                            </td>
                                            <td style="text-transform: uppercase; text-align: left;"><?= $enrollmenthistoryibeddata['studfullname']; ?></td>
                                            <td style="text-align: center;">
                                                <?php 
                                                    if($enrollmenthistoryibeddata['sy'] == '') {
                                                        echo "-";
                                                    } else {
                                                        echo $enrollmenthistoryibeddata['sy'];
                                                    }
                                                ?>
                                            </td>
                                            <td style="text-align: center;">
                                                <?php 
                                                    if($enrollmenthistoryibeddata['level'] == '') {
                                                        echo "-";
                                                    } else {
                                                        echo $enrollmenthistoryibeddata['name'];
                                                    }
                                                ?>
                                            </td>
                                            <td style="text-align: center;"><?php echo $formattedDate = date('F j, Y', strtotime($enrollmenthistoryibeddata['date'])); ?>
                                            </td>
                                            <td style="text-align: center;">
                                                <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View Assessment"
                                                    onclick="window.location.href='<?= base_url(); ?>ibed-assessment/view/<?= $enrollmenthistoryibeddata['studid']; ?>';">
