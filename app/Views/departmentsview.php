                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($deptdata as $deptd):?>
                                        <tr>
                                            <td><?= $deptd['deptid']; ?></td>
                                            <td><?= $deptd['deptcode']; ?></td>
                                            <td><?= $deptd['deptname']; ?></td>
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $deptd['deptid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $deptd['deptid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('departments/update/'.$deptd['deptid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">CODE</label>
                                                                        <input type="text" name="dcode" class="form-control" value="<?php echo $deptd['deptcode']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">DEPARTMENT</label>
                                                                        <input type="text" name="department" class="form-control" value="<?php echo $deptd['deptname']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>departments/delete/<?= $deptd['deptid']; ?>';">
                                                        <span class="btn-inner">
