                        ...
                        <?= form_open('courses'); ?>
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <label class="form-label" for="validationDefault01">COURSE CODE</label>
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($coursedata as $courd):?>
                                        <tr>
                                            <td><?= $courd['courid']; ?></td>
                                            <td><?= $courd['courcode']; ?></td>
                                            <td><?= $courd['course']; ?></td>
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $courd['courid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $courd['courid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('courses/update/'.$courd['courid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">COURSE CODE</label>
                                                                        <input type="text" name="coursecode" class="form-control"
                                                                        value="<?php echo $courd['courcode']; ?>">
                                                                    </div>
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="validationDefault01">COURSE</label>
                                                                        <input type="text" name="course" class="form-control"
                                                                        value="<?php echo $courd['course']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>courses/delete/<?= $courd['courid']; ?>';">
                                                        <span class="btn-inner">
