                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <label class="form-label" for="exampleFormControlSelect1">DEPARTMENT</label>
                                        <select name="department" class="form-select" id="exampleFormControlSelect1">
                                        <option selected="" disabled=""></option>
                                        <?php foreach ($deptdata as $deptd): ?>
                                            <option value="<?php echo $deptd['deptid']; ?>"><?php echo $deptd['deptname']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <?php foreach($leveldata as $leveld):?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php foreach($deptdata as $deptd): ?>
                                                    <?php if($deptd['deptid'] == $leveld['leveldeptid']): ?>
                                                        <?= $deptd['deptname']; ?>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </td>
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $leveld['levelid']; ?>">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $leveld['levelid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('levels/update/'.$leveld['levelid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">LEVEL</label>
                                                                        <input type="text" name="levels" class="form-control" value="<?php echo $leveld['level']; ?>">
                                                                    </div>
                                                                    <div class="col-lg-12 col-sm-12">
                                                                        <label class="form-label" for="exampleFormControlSelect1">DEPARTMENT</label>
                                                                            <select name="department" class="form-select" id="exampleFormControlSelect1">
                                                                            <option value="<?= $leveld['leveldeptid']; ?>" selected>
                                                                                <?php foreach($deptdata as $deptd): ?>
                                                                                    <?php if($deptd['deptid'] == $leveld['leveldeptid']): ?>
                                                                                        <?= $deptd['deptname']; ?>
                                                                                    <?php endif; ?>
                                                                            ...
                                                                            <?php foreach ($deptdata as $deptd): ?>
                                                                                <option value="<?= $deptd['deptid']; ?>"><?php echo $deptd['deptname']; ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>levels/delete/<?= $leveld['levelid']; ?>';">
                                                        <span class="btn-inner">
