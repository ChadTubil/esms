                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    <?php foreach($semdata as $sd):?>
                                        <tr>
                                            <td><?= $sd['semid']; ?></td>
                                            <td><?= $sd['semester']; ?></td>
                                            <td>
                                                <?php if($sd['semstatus'] == 1): ?>
                                                    <?= "Ended"; ?>
                                                <?php else: ?>
                                                    <?= "Active"; ?>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <button class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Disable Semester"
                                                        onclick="window.location.href='<?= base_url(); ?>semester/disable/<?= $sd['semid']; ?>';"
                                                        <?php if($sd['semstatus'] == 1){echo 'hidden';}else{} ?>>
                                                    ...
                                                    <button class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable Semester"
                                                        onclick="window.location.href='<?= base_url(); ?>semester/enable/<?= $sd['semid']; ?>';"
                                                        <?php if($sd['semstatus'] == 0){echo 'hidden';}else{} ?>>
                                                        <span class="btn-inner">
                                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $sd['semid']; ?>">
                                                        <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $sd['semid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('semester/update/'.$sd['semid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">SEMESTER</label>
                                                                        <input type="text" name="semester" class="form-control" value="<?php echo $sd['semester']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>semester/delete/<?= $sd['semid']; ?>';">
                                                        <span class="btn-inner">
