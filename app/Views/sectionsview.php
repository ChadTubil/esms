                                ...
                                <div class="col-lg-8 col-sm-12">
                                    <label class="form-label" for="exampleFormControlSelect1">COURSE</label>
                                        ...
                                        <?php foreach ($coursedata as $coursed): ?>
                                            <option value="<?php echo $coursed['courid']; ?>"><?php echo $coursed['course']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $sectiond['secid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('sections/update/'.$sectiond['secid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8 col-sm-12">
                                                                            <label class="form-label" for="exampleFormControlSelect1">COURSE</label>
                                                                                <select name="course" class="form-select" id="exampleFormControlSelect1">
                                                                                <option value="<?php echo $sectiond['seccourid']; ?>" selected>
                                                                                    <?php foreach($coursedata as $courd): ?>
                                                                                        <?php if($courd['courid'] == $sectiond['seccourid']): ?>
                                                                                            <?= $courd['course']; ?>
                                                                                        <?php endif; ?>
                                                                                    <?php endforeach; ?>
                                                                                </option>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>sections/delete/<?= $sectiond['secid']; ?>';">
                                                        <span class="btn-inner">
