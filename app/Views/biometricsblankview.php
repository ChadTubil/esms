                    ...
                    <div class="col-md-8" style="border-left-style: solid;">
                        <div class="row justify-content-center">
                            <div style="background-color: #263A56; text-align: center;">
                                ...
                                <br>
                                <br>
                                <h2 style="color: white;"><strong>EMPLOYEE NAME</strong></h2>
                                <h4 style="color: #fecc09;"><strong>EMPLOYEE NUMBER</strong></h4>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-4" style="text-align: center;">
                                        <h1 style="color: white; text-transform: uppercase;"><strong>DATE</strong></h1>
                                    </div>
