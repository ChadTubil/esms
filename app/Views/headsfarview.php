            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <?php endif; ?>
                            <?php echo form_open('fpa'); ?> 
                                <div class="row">
                                    <div class="col-lg-9 col-sm-12">
                                        <label class="form-label" for="validationDefault01">SEARCH FACULTY</label>
                                        <input type="text" name="searchfaculty" class="form-control"
                                        placeholder="Search Employee Number/Name">
                                    </div>
                                    <div class="col-lg-3 col-sm-12">
                                        <button class="btn btn-success" type="submit" name="add" style="width: 100%; height: 100%;">SEARCH FACULTY</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>    
                    </div>
