                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <button class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="End School Year"
                                                        onclick="window.location.href='<?= base_url(); ?>schoolyear/end/<?= $syd['syid']; ?>'"
                                                        <?php if($syd['systatus'] == 1){echo 'hidden';}else{} ?>>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-primary" title="Edit"
                                                        href="#" data-bs-toggle="modal" data-bs-target="#editModal<?= $syd['syid']; ?>">
                                                        <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $syd['syid']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content dark">
                                                                ...
                                                                <?= form_open('schoolyear/update/'.$syd['syid']); ?>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="email" class="form-label">SCHOOL YEAR</label>
                                                                        <input type="text" name="schoolyear" class="form-control" value="<?php echo $syd['syname']; ?>">
                                                                    </div>
                                                                    <br>
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        onclick="window.location.href='<?= base_url(); ?>schoolyear/delete/<?= $syd['syid']; ?>'">
                                                        <span class="btn-inner">
