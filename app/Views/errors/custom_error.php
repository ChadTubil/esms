...
<html lang="en" dir="ltr">
    ...
    <body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
        <div class="wrapper">
            ...
            <div class="gradient">
                <div class="container">
                    <img src="<?= base_url(); ?>/public/assets/images/error/404.png" class="img-fluid mb-4 w-50" alt=""> 
                    <h2 class="mb-0 mt-4 text-white">Oops! This Page is Not Found.</h2>
                    <p class="mt-2 text-white">The requested page dose not exist.</p>
                    <a class="btn bg-white text-primary d-inline-flex align-items-center" href="<?= base_url(); ?>dashboard">Back to Home</a>
                </div>
                <div class="box">
