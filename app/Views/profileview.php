                            ...
                            <?php foreach($usersaccess as $usera): ?>
                                <?php if($usera['ustudent'] == 1): ?>
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="header-title">
                                        <h4 class="card-title">ACTIVE ENROLLMENT STATUS</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <ul class="list-inline p-0 m-0">
                                            <?php foreach($etddata as $etdd): ?>
                                                <!-- REGISTERED -->
                                                <?php if($etdd['status'] == 'Registered' || $etdd['status'] == 'Admitted' || $etdd['status'] == 'Advised' || $etdd['status'] == 'Payment'): ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-success text-primary"></div>
                                                        <h6 class="float-left mb-1">REGISTRATION <span class="badge bg-success rounded-pill">DONE</span></h6>
                                                        <small class="float-right mt-1"><?= date('F j, Y', strtotime($etdd['date'])); ?></small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Registered for <?= $etdd['sy']; ?> S.Y. <?= $etdd['sem']; ?> - <?= $etdd['level']; ?>.</p>
                                                        </div>
                                                    </li>
                                                <?php else: ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-danger text-primary"></div>
                                                        <h6 class="float-left mb-1">REGISTRATION <span class="badge bg-danger rounded-pill">PENDING</span></h6>
                                                        <small class="float-right mt-1"><?= date('F j, Y', strtotime($etdd['date'])); ?></small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Registered for <?= $etdd['sy']; ?> S.Y. <?= $etdd['sem']; ?> - <?= $etdd['level']; ?>.</p>
                                                        </div>
                                                ...
                                                <?php endif; ?>
                                                <!-- ADMITTED -->
                                                <?php if($etdd['status'] == 'Admitted' || $etdd['status'] == 'Advised' || $etdd['status'] == 'Payment'): ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-success text-success"></div>
                                                        <h6 class="float-left mb-1">ADMISSION <span class="badge bg-success rounded-pill">DONE</span></h6>
                                                        <small class="float-right mt-1"></small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Admitted for <?= $etdd['sy']; ?> S.Y. <?= $etdd['sem']; ?> - <?= $etdd['level']; ?>.</p>
                                                        </div>
                                                    </li>
                                                <?php else: ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-danger text-success"></div>
                                                        <h6 class="float-left mb-1">ADMISSION <span class="badge bg-danger rounded-pill">PENDING</span></h6>
                                                        <small class="float-right mt-1">Instructions:</small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Please go to <strong>GUIDANCE OFFICE</strong>.</p>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                                                <!-- ADVISED -->
                                                <?php if($etdd['status'] == 'Advised' || $etdd['status'] == 'Payment'): ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-success text-success"></div>
                                                        <h6 class="float-left mb-1">ADVISING <span class="badge bg-success rounded-pill">DONE</span></h6>
                                                        <small class="float-right mt-1">Instructions:</small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Please go to your <strong>REGISTRAR'S OFFICE</strong> and get your COR.</p>
                                                        </div>
                                                    </li>
                                                <?php else: ?>
                                                    <li>
                                                        <div class="timeline-dots timeline-dot1 border-danger text-success"></div>
                                                        <h6 class="float-left mb-1">ADVISING <span class="badge bg-danger rounded-pill">PENDING</span></h6>
                                                        <small class="float-right mt-1">Instructions:</small>
                                                        <div class="d-inline-block w-100">
                                                            <p>Please go to your <strong>PROGRAM CHAIR</strong>.</p>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                                                <!-- FOR PAYMENT -->
                                                <li>
                                                    <div class="timeline-dots timeline-dot1 border-danger text-primary"></div>
                                                    <h6 class="float-left mb-1">FOR PAYMENT <span class="badge bg-danger rounded-pill">PENDING</span></h6>
                                                    <small class="float-right mt-1">Instructions:</small>
                                                    <div class="d-inline-block w-100">
                                                        <p>Please go to <strong>CASHIER</strong>.</p>
                                                    </div>
                                                </li>
                                                <!-- ENROLLED  -->
                                                <li>
                                                    <div class="timeline-dots timeline-dot1 border-danger text-warning"></div>
                                                    <h6 class="float-left mb-1">ENROLLMENT <span class="badge bg-danger rounded-pill">PENDING</span></h6>
                                                    <small class="float-right mt-1">Instructions:</small>
                                                    <div class="d-inline-block w-100">
                                                        <p>Currently your not enrolled.</p>
                                                    </div>
                                                </li>
                                            <?php endforeach; ?>
                                        </ul>
                    ...
                    <div class="card-body">
                        <!-- <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/05.png" alt="story-img" class="rounded-pill avatar-40"></div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-danger rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/03.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Robert Fox</h6>
                                    <p class="mb-0">4 mutual friends</p>
                                </div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-dark rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/06.png" alt="story-img" class="rounded-pill  profile-story-img avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Jenny Wilson</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-primary rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/07.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Cody Fisher</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-info rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/04.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Bessie Cooper</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/02.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Wade Warren</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-success rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/01.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Guy Hawkins</h6>
                            ...
                            <li class="d-flex align-items-center">
                                <div class="img-fluid bg-soft-info rounded-pill"><img src="<?= base_url(); ?>public/assets/images/icons/08.png" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Floyd Miles</h6>
