        ...
        function proceedWithRegistration(program) {
            ...
            switch(program) {
                case 'grade-school':
                    ...
                    window.location.href = '<?= base_url(); ?>online-registration-gs';
                    break;
                case 'shs':
                    // alert('Senior High School program selected. Redirecting to SHS registration form...');
                    window.location.href = '<?= base_url(); ?>online-registration-shs';
                    break;
                case 'college':
                    // alert('College program selected. Redirecting to College registration form...');
                    window.location.href = '<?= base_url(); ?>online-registration-college';
                    break;
            }
