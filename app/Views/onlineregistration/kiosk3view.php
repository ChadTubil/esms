                    ...
                    <div class="card-body">
                        <div class="success-card animate__animated animate__fadeInUp">
                            ...
                            <div class="card-body" style="width: 100%; text-align: center;">
                                <div class="info-box" style="margin-left: 30%; margin-right: 30%;">
                                    <p style="color: black; font-size: 30px;">
                                        <i class="fas fa-info-circle" style="color: red"></i>
                                        <strong style="color: red;">Important:</strong>
                                        <strong>Please to guidance office for the next step!</strong>
                                    </p>
                                </div>
                                <div class="action-buttons">
                                    <a href="<?= base_url() ?>kiosk-registration" class="btn btn-custom btn-primary">
